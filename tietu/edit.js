	...
	$.prototype = {
		init: function() {
			...
			this.dom.addEventListener("tap",function(e){
				...
				bkMP3 = bkMP3.substring(bkMP3.lastIndexOf("/")+1,bkMP3.lastIndexOf("."));
				var _location = "_www/mp3/tietuMp3/"+bkMP3+".mp3";
			...
			this.closeBtn.addEventListener("tap", function(e) {
				...
				document.getElementById("appmask").style.display = 'block';
